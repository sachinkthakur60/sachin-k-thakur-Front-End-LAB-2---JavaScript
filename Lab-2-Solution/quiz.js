...
let q2 = new Question ("Which language is user for styling web pages?");
...
function QuestionAnswerPair(question, correntAnswer, answerChoices){
    this.question = question;
    this.correntAnswer = correntAnswer;
    this.answerChoices = answerChoices;

    this.isACorrectAnswer = function(userAnswer){
        if(this.correntAnswer.answerText===userAnswer){
...
let qaPair2= new QuestionAnswerPair(q2, a2, [new Answer("HTML"), new Answer("JQuery"), a2, new Answer("XML")]);
...
function Quiz(qaPairArray){
    ...
    this.displayFinalScorePage = function(){
        ...
        `<h1>Result</h1> 
        <p id='question'>Your scores ${scores}. Mark Percentage is ${percentage}%</p>`;
